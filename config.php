...
$apiKey = 'Ek5E65kd7NsdR8V2wYKQMD2qaBH8J1HYtYXnv5n8vJQLM6u9n1bnxywo';          // Ключ доступа к API
$offer_id = 11089;         // для каждого оффера свой айди, надо уточнять его в админке или у суппортов
$stream_hid = 'jKOUO0Nn';     // id потока

$landKey = '32d329b8d663277cef1d6a66c638df67';
...
$dataOffers = '{"36302":{"id":36302,"name":"MYRALOSE","country":{"code":"DZ","name":"\u0410\u043b\u0436\u0438\u0440"},"price":"5990","price2":"11990","currency":{"code":"DZD","name":"DA"}}}';
$dataOffer = '{"id":36302,"name":"MYRALOSE","country":{"code":"DZ","name":"\u0410\u043b\u0436\u0438\u0440"},"price":"5990","price2":"11990","currency":{"code":"DZD","name":"DA"}}';
$is_geo_detect = '';
$productName = 'MYRALOSE';
$invoice = 'index.php';
$language = 'ar';
$push_link = '';
$fb_verification = '';
